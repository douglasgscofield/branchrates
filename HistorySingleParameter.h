#ifndef HISTORY_SINGLE_PARAMETER_H
#define HISTORY_SINGLE_PARAMETER_H
...
class HistorySingleParameter {
    public:
        ...
        friend std::ostream&   operator<<(std::ostream& os,
                                          const HistorySingleParameter& h);
};
...
inline HistorySingleParameter::HistoryEntry::HistoryEntry(double pa, double ep,
...
inline HistorySingleParameter::HistoryEntry&
                       HistorySingleParameter::operator[](int i) {
    return(history[i]);
}
...
inline void HistorySingleParameter::add(double pa, double ep, double de,
...
inline void HistorySingleParameter::clear() {
    history.clear();
}

inline int HistorySingleParameter::size() const {
    return(history.size());
}

#endif  // HISTORY_SINGLE_PARAMETER_H
